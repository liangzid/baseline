...
# Options
# --------
parser = argparse.ArgumentParser(description='Training')#默认为训练模式
parser.add_argument('--gpu_ids',default='0', type=str,help='gpu_ids: e.g. 0  0,1,2  0,2')
parser.add_argument('--which_epoch',default='last', type=str, help='0,1,2,3...or last')
parser.add_argument('--test_dir',default='/home/liangzi/Market1501/pytorch',type=str,
                    help='./test_data')
...
if not opt.PCB:
    model.model.fc = nn.Sequential()     #为什么要移除啊!
